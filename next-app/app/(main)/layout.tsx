...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative flex min-h-screen text-foreground bg-linear-to-b from-black to-zinc-950">
      ...
      {/* Main column */}
      <div className="relative flex flex-col flex-1 rounded-[3rem] border m-2 overflow-hidden h-[calc(100vh-1rem)] ">
        ...
        <div className="pointer-events-none absolute inset-0 ">
          <Image
            ...
            fill
            priority
            className="object-cover  opacity-50 blur"
          />
        </div>
