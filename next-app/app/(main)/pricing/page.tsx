          ...
          <div className="">
            ...
            <div className="mx-auto max-w-4xl space-y-7 px-2 py-12 text-center sm:py-16">
              ...
              <div className="flex flex-wrap items-center justify-center gap-2">
                ...
                <div className="rounded-full border border-foreground/8 bg-transparent px-4 py-2 text-xs font-medium text-zinc-500">
                  Mainnet next
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-4 xl:grid-cols-3">
              ...
              <Card className="relative overflow-hidden rounded-[2rem] border border-foreground/8 bg-zinc-950/80 p-7 shadow-[0_20px_70px_rgba(0,0,0,0.26)] before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_top_left,rgba(52,211,153,0.22),transparent_42%)]">
                <div className="relative flex h-full flex-col gap-7">
                  <div className="space-y-5">
                    ...
                    <div className="flex flex-wrap items-baseline gap-1.5">
                      ...
                      <span className="text-xs font-medium text-zinc-500">expected monthly range</span>
                    </div>
                  </div>
          ...
          <Card className="px-8 max-w-3xl mx-auto border-0 bg-foreground/[0.03] mt-12">
            <div className="space-y-5">
              <div className="flex items-center justify-between gap-4">
                <div className="space-y-2">
                  <p className="text-xs text-zinc-500">Current wallet status</p>
              ...
              <p className="text-sm leading-7 text-zinc-500">{walletStateCopy.body}</p>

              {connected && address ? (
                <div className="rounded-[1.4rem]  bg-foreground/[0.02] p-4">
                  <div className="text-xs  text-zinc-500">Connected wallet</div>
                  <div className="mt-2 break-all font-mono text-sm text-zinc-200">{address}</div>
                </div>
              ) : (
              ...
              <div className="flex items-start gap-3 rounded-[1.4rem] ">
                ...
                <p className="text-sm leading-6 text-zinc-500">
                  Pro is free during testnet. On mainnet, Pro is expected to become a paid plan, likely around <span className="font-medium text-zinc-100">$20/month</span>. Final pricing may still evolve.
                </p>
              </div>
            </div>
          </Card>
