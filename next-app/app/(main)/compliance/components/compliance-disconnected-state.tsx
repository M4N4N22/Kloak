...
export function ComplianceDisconnectedState() {
  return (
    <div className="space-y-6">
      <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br from-zinc-900 via-background to-emerald-500/10 p-8">
      ...
      <Card className="border-white/10 bg-black/20">
        <CardContent className="grid gap-4 p-6 text-sm text-muted-foreground md:grid-cols-3">
          <div>
            <div className="font-medium text-white">Payer workflows</div>
            <p className="mt-1">Show a payment exists, prove the exact amount, or satisfy a reimbursement threshold.</p>
          </div>
          <div>
            <div className="font-medium text-white">Receiver workflows</div>
